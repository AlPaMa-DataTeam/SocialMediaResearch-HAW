...
```{r, include=FALSE}
# Packages
packages <- c("ggplot2", "dplyr", "readr", "stringr", "purrr", "janitor", "ggrepel", "rtweet", "twitteR", "purrr", "tidyr", "raster", "leaflet", "sf", "rgeos")
...
de_map$randomData <- rnorm(n=nrow(de_map2), 150, 30)

pal <- colorQuantile("Reds", NULL, n = 9)
popup <- paste0("<strong>Bundesland: </strong>", de_map2$NAME_1, "<br>",
