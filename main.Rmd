...
mainDataWithState = mainDataWithTweets %>% 
...
popup <- paste0("<strong>Bundesland: </strong>", de_map$NAME_1, "<br>",
                "<strong>Anzahl der Tweets: </strong>", de_map$no_tweets)
...
ggplot(missingTwitterUsers, aes(x="", y=missingTwitterUsers$missing, fill=missingTwitterUsers$missing)) +
