...
# Nicht benötigtes DF. Wird nach dem nächsten Commit gelöscht
tweetAmountPerUser = allScrapedTweets %>% 
...
```{r}
# ggplot version wird nach dem nächsten commit gelöscht
...
# Wird beim nächstne commit gelöscht
ggplotly(stackedBar) %>% 
